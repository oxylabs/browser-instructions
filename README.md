...
*All information herein is provided on an “as is” basis and for
...
terms of service or receive a scraping license.*
...
> 1.1 Wait for the element to load;

2.  **Enter** “11238” into the input field;

3.  **Click** “Update”;

> 4.1 Wait for the page to reload.
...
**Note:** To scroll up, use a negative value, for instance -100.
...
able to scrape a total of 30 products under the “More to love” section
...
- Get only the data you need instead of dealing with the entire HTML
  > document.
